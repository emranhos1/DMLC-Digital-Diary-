<%-- 
    Document   : dashboard
    Created on : Sep 19, 2017, 12:01:44 PM
                ...
                <div class="row col-xl-12">
                    <div class="col-xl-6 col-sm-6 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            ...
                            <a class="card-footer text-white clearfix small z-1" href="allNewWork.jsp">
                    ...
                    <div class="col-xl-6 col-sm-6 mb-3">
                        <div class="card text-white bg-warning o-hidden h-100">
                            ...
                            <a class="card-footer text-white clearfix small z-1" href="endWork.jsp">
                                <span class="float-left">বিস্তারিত দেখুন</span>
                                <span class="float-right">
                                    <i class="fa fa-angle-right"></i>
                                </span>
